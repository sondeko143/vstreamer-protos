...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in vstreamer_protos/commander/commander_pb2_grpc.py depends on'
...
def add_CommanderServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('voicerecog.Commander', rpc_method_handlers)
