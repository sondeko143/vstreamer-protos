...
pub mod commander_server {
    ...
    #[async_trait]
    pub trait Commander: std::marker::Send + std::marker::Sync + 'static {
                ...
                "/voicerecog.Commander/process_command" => {
                    ...
                    for process_commandSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Commander>::process_command(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/voicerecog.Commander/sync_process_command" => {
                    ...
                    for sync_process_commandSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Commander>::sync_process_command(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for CommanderServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "voicerecog.Commander";
    impl<T> tonic::server::NamedService for CommanderServer<T> {
